...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'wrumwrum';
	var applicationModuleVendorDependencies = ['ngResource', 'ngCookies',  'ngAnimate',  'ngTouch',  'ui.router', 'ui.bootstrap', 'ui.utils', 'ngFileUpload'];
...
angular.module('posts').config(['$stateProvider',
    function($stateProvider) {
        ...
        state('main', {
            url: '/',
            templateUrl: 'modules/posts/views/allposts.client.view.html'
        }).
        state('new-post', {
            url: '/new-post',
            templateUrl: 'modules/posts/views/new_post.client.view.html'
        }).
        state('post', {
            url: '/post/:id',
            templateUrl: 'modules/posts/views/post.client.view.html'
        });
    }
]);
'use strict';
...
(function (angular) {
    ...
    angular.module('posts').controller('postDirectiveCtrl', ["$scope", "$element", "$attrs", function($scope, $element, $attrs) {
